...
'''This module provides the gui information for running Beep_Inn with an graphical interface
It is enabled there and called up to provide a gui for debugging and changing settings..
'''
import time
import pygame
